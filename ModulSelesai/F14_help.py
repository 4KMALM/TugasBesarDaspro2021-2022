def help(is_login,role):
  ...
  if is_login:
    if role == "admin":
      print("1. login (Anda sudah login) - Untuk melakukan login ke dalam sistem")
      ...
      print("6. topup - Untuk menambahkan saldo pengguna")
      ...
      print("1. login (Anda sudah login) - Untuk melakukan login ke dalam sistem")
      print("2. buy_game - Untuk membeli game pada toko")
      print("3. list_game - Untuk melihat daftar game anda")
      print("4. search_my_game - Untuk mencari game dari daftar game anda")
      print("5. riwayat - Untuk melihat riwayat pembelian game anda")
    ...
    print("ketik \"login\" Untuk melakukan login ke dalam sistem")
